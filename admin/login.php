...
?>
			...
			<div class="row">
				<div class="module module-login span4 offset4">
						...
						<div class="module-body">
							...
							<div class="control-group">
								<div class="controls row-fluid">
                                                                    <input class="span12" type="password" id="inputPassword" placeholder="Password" name="pass" AUTOCOMPLETE="off">
								</div>
							</div>
						</div>
	...
	<div class="footer">
        <div class="container">
            <b class="copyright">&copy; 2022 - VTSBook </b>All rights reserved.
        </div>
    </div>
</body>
</html>